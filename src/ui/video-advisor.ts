...
export function renderVideoAdvisor(): string {
  ...
  return `<style>
    .niubigeo-advisor-card { position:fixed; z-index:12; right:18px; bottom:18px; display:flex; align-items:center; gap:10px; width:218px; max-width:calc(100vw - 32px); min-height:52px; padding:8px 10px; border:1px solid #2d3f57; border-radius:12px; background:#101722; color:#f5f7fb; text-decoration:none; box-shadow:0 6px 8px #0006; transition:border-color 160ms,background-color 160ms; }
  ...
  <a class="niubigeo-advisor-card" data-niubigeo-advisor href="https://niubigeo.ai/advisor" target="_blank" rel="noopener noreferrer" referrerpolicy="no-referrer" aria-label="NiubiGEO AI 顾问：前往官网咨询（新标签页）">
    ...
    <span class="niubigeo-advisor-copy"><strong>AI 顾问</strong><span>与 NiubiGEO 对话</span></span>
